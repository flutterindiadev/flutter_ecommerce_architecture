...
class OrderRepositoryImpl extends OrderRepository{
  ...
  @override
  Future<Either<NetworkError, OrderItem?>> getOrderDetail({required String? orderId}) {
   return networkPort.getOrderDetail(orderId: orderId);
  }

  @override
  Future<Either<NetworkError, OrderRating>> getorderRating({required OrderRatingRequest orderRatingRequest}) {
    return networkPort.getOrderRating(orderRatingRequest: orderRatingRequest);

  }

  @override
  Future<Either<NetworkError, OrderRepeat>> doOrderRepeat({required String? orderId}) {
    return networkPort.doOrderRepeat(orderId: orderId);
  }

  @override
  Future<Either<NetworkError, OrderCancel>> orderCancel({required String? orderId}) {
